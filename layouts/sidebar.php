        ...
        if ($level == 0) {
            ...
            <div class="sidenav-header mb-2">
                ...
                <a class="navbar-brand" href="" target="_blank">
                    <img src="<?php echo "
                    ../image/brt2.png" ?>" class="navbar-brand-img h-100 ms-5" alt="main_logo" />
                    <span class=" font-weight-bold  text-white ms-1 ">
                        E - Arsip<br>
                        <i class="ms-4">
                            Kecamatan Mandastana</i>
                    </span>
                </a>
            </div>
                    ...
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li>
                            <a class="nav-link text-white " href="?page=data_SOON">
                                ...
                                <span class="nav-link-text ms-1">SOON!!</span>
                            </a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Laporan SOON!</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group text-center">
                                                <a href="../laporan/l_spn.php" target="_blank" class="btn btn-info btn-md">
                                                    <i class="fa fa-print"></i>
                                                    Cetak Semua</a>
                                            </div>
                                        </div>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="data-master">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li>
                                    <a class="nav-link text-white " href="?page=SOOONNN">
                                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                            <i class="material-icons opacity-10">assignment</i>
                                        </div>
                                        <span class="nav-link-text ms-1">SOON!!</span>
            ...
            if ($level == 3) {
                ...
                <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="" data-bs-toggle="collapse" data-bs-target="#data-perjalanandinas">
                                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                    <i class="material-icons opacity-10">directions_car</i>
                                </div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="laporan-laporan">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" target="_blank" action="../laporan/l_sktm.php">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-4" style="margin-top: 31px;">
                                                                    <button align="center" type="submit" name="cetak2" class="btn btn-info btn-md">
                                                                        <i class="fa fa-print"></i>
                                                                        Cetak</button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <hr>
                                                        <div class="form-group text-center">
                                                            <a href="../laporan/l_sktm.php" target="_blank" class="btn btn-info btn-md">
                                                                <i class="fa fa-print"></i>
                                                                Cetak Semua</a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" target="_blank" action="../laporan/l_sk.php">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-4" style="margin-top: 31px;">
                                                                    <button align="center" type="submit" name="cetak3" class="btn btn-info btn-md">
                                                                        <i class="fa fa-print"></i>
                                                                        Cetak</button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <hr>
                                                        <div class="form-group text-center">
                                                            <a href="../laporan/l_sk.php" target="_blank" class="btn btn-info btn-md">
                                                                <i class="fa fa-print"></i>
                                                                Cetak Semua</a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" target="_blank" action="../laporan/l_rdn.php">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-4" style="margin-top: 31px;">
                                                                    <button align="center" type="submit" name="cetak4" class="btn btn-info btn-md">
                                                                        <i class="fa fa-print"></i>
                                                                        Cetak</button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <hr>
                                                        <div class="form-group text-center">
                                                            <a href="../laporan/l_rdn.php" target="_blank" class="btn btn-info btn-md">
                                                                <i class="fa fa-print"></i>
                                                                Cetak Semua</a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" target="_blank" action="../laporan/l_lp.php">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-4" style="margin-top: 31px;">
                                                                    <button align="center" type="submit" name="cetak5" class="btn btn-info btn-md">
                                                                        <i class="fa fa-print"></i>
                                                                        Cetak</button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <hr>
                                                        <div class="form-group text-center">
                                                            <a href="../laporan/l_lp.php" target="_blank" class="btn btn-info btn-md">
                                                                <i class="fa fa-print"></i>
                                                                Cetak Semua</a>
                                                        </div>
                                                    </div>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-white ">
                                            <div class="text-white me-2 d-flex " type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal6">
                                                <i class="material-icons opacity-10">print</i>
                                        ...
                                        <div class="modal fade" id="exampleModal6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" target="_blank" action="../laporan/l_news.php">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-4" style="margin-top: 31px;">
                                                                    <button align="center" type="submit" name="cetak6" class="btn btn-info btn-md">
                                                                        <i class="fa fa-print"></i>
                                                                        Cetak</button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <hr>
                                                        <div class="form-group text-center">
                                                            <a href="../laporan/l_news.php" target="_blank" class="btn btn-info btn-md">
                                                                <i class="fa fa-print"></i>
                                                                Cetak Semua</a>
                                                        </div>
                                                    </div>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-white ">
                                            <div class="text-white me-2 d-flex " type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal7">
                                                <i class="material-icons opacity-10">print</i>
                                        ...
                                        <div class="modal fade" id="exampleModal7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group text-center">
                                                            <a href="../laporan/l_msy.php" target="_blank" class="btn btn-info btn-md">
                                                                <i class="fa fa-print"></i>
                                                                Cetak Semua</a>
                                                        </div>
                                                    </div>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-white ">
                                            <div class="text-white me-2 d-flex" type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal8">
                                                <i class="material-icons opacity-10">print</i>
                                        ...
                                        <div class="modal fade" id="exampleModal8" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" target="_blank" action="../laporan/l_KinerjaKec.php">
                                                            <div class="form-group row">
                                                                <div class="col-md-4">
                                                                    <label>Dari Tanggal</label>
                                                                    <input type="date" class="form-control" name="tgl1" required>
                                                                ...
                                                                <div class="col-md-4" style="margin-top: 31px;">
                                                                    <button align="center" type="submit" name="cetak8" class="btn btn-info btn-md">
                                                                        <i class="fa fa-print"></i>
                                                                        Cetak</button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <hr>
                                                        <div class="form-group text-center">
                                                            <a href="../laporan/l_KinerjaKec.php" target="_blank" class="btn btn-info btn-md">
                                                                <i class="fa fa-print"></i>
                                                                Cetak Semua</a>
                                                        </div>
                                                    </div>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-white ">
                                            <div class="text-white me-2 d-flex" type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal9">
                                                <i class="material-icons opacity-10">print</i>
                                        ...
                                        <div class="modal fade" id="exampleModal9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Laporan Kinerja
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" target="_blank" action="../laporan/l_KinerjaPegawai.php">
                                                            <div class="form-group row">
                                                                <div class="col-md-4">
                                                                    <label>Dari Tanggal</label>
                                                                    <input type="date" class="form-control" name="tgl1" required>
                                                                ...
                                                                <div class="col-md-4" style="margin-top: 31px;">
                                                                    <button align="center" type="submit" name="cetak9" class="btn btn-info btn-md">
                                                                        <i class="fa fa-print"></i>
                                                                        Cetak</button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <hr>
                                                        <div class="form-group text-center">
                                                            <a href="../laporan/l_KinerjaPegawai.php" target="_blank" class="btn btn-info btn-md">
                                                                <i class="fa fa-print"></i>
                                                                Cetak Semua</a>
                                                        </div>
                                                    </div>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-white ">
                                            <div class="text-white me-2 d-flex" type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal10">
                                                <i class="material-icons opacity-10">print</i>
                                                <span class="nav-link-text ms-1">Laporan Data
                                                    <br>
                                        ...
                                        <div class="modal fade" id="exampleModal10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Laporan
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" target="_blank" action="../laporan/l_PerjalananDinas.php">
                                                            <div class="form-group row">
                                                                <div class="col-md-4">
                                                                    <label>Dari Tanggal</label>
                                                                    <input type="date" class="form-control" name="tgl1" required>
                                                                ...
                                                                <div class="col-md-4" style="margin-top: 31px;">
                                                                    <button align="center" type="submit" name="cetak10" class="btn btn-info btn-md">
                                                                        <i class="fa fa-print"></i>
                                                                        Cetak</button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <hr>
                                                        <div class="form-group text-center">
                                                            <a href="../laporan/l_PerjalananDinas.php" target="_blank" class="btn btn-info btn-md">
                                                                <i class="fa fa-print"></i>
                                                                Cetak Semua</a>
                                                        </div>
                                                    </div>
