                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <div class="input-group input-group-dynamic mb-4">
                                                        <input class="form-control" type="text" name="nama" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required value="<?= $data['nama'] ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <div class="input-group input-group-dynamic mb-4">
                                                        <input class="form-control" type="text" name="no_ktp" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required value=" <?= $data['no_ktp'] ?> " />
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <div class="input-group input-group-dynamic mb-4">
                                                        <input class="form-control" aria-label="Tanggal Lahir" type="date" name="tgl_lhr" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required value="<?= $data['tgl_lhr'] ?>">
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <div class="input-group input-group-dynamic mb-4">
                                                        <input class="form-control" type="text" name="tmpt_lhr" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required value="<?= $data['tmpt_lhr'] ?> " />
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group input-group-dynamic">
                                                    <div class="input-group input-group-dynamic mb-4">
                                                        <input class="form-control" aria-label="agama" type="text" name="agama" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" value="<?= $data['agama'] ?>" required>
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <div class="input-group input-group-dynamic mb-4">
                                                        <input class="form-control" type="text" name="no_tlp" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required value="<?= $data['no_tlp'] ?> " />
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <div class="input-group input-group-dynamic mb-4">
                                                        <input class="form-control" aria-label="alamat" type="text" name="alamat" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required value="<?= $data['alamat'] ?>">
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                            </div>
