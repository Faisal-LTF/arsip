...
if (!isset($_SESSION['nama'])) {
    ...
    $id = $_GET['id'];
    $query = $link->query("SELECT * FROM surat_keluar WHERE id_suratKeluar = '$id'");
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 ">
                                    <div class="card">
                                                ...
                                                <ul class="nav  nav-pills nav-fill p-2" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="true">
                                                            <i class="material-icons text-lg position-relative">skip_previous</i>
                                        ...
                                        <div class="card-body">
                                            <p class="text-uppercase text-sm">Informasi Surat Keluar</p>
                                            <div class="row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label text-bold">Tujuan Surat</label>
                                                    <div class="input-group input-group-dynamic">
                                                        <div class="input-group input-group-dynamic mb-4">
                                                            <input class="form-control" aria-label="Tujuan Surat" type="text" name="tujuan_surat" data-minlength="4" data-error="Tidak Boleh Kurang dari 4" required value="<?= $data['tujuan_surat'] ?>">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                </div>
