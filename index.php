...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="../e-arsip/assets/img/apple-icon.png" />
    <link rel="icon" type="image/png" href="<?php echo "image/brt2.png" ?>">
                            ...
                            <div class=" p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-info border-radius-lg py-3 pe-1">
                                    <div style="text-align: center;">
                                        <img src="<?php echo "image/brt2.png" ?>" width="185px" height="170px"
                                            alt="Logo">
                                    </div>
                                    <div class="row mt-0 text-center">
                                        <h4 class="text-white font-weight-bolder text-center mt-3 ">
                                            E-ARSIP </h4>
                                        <h5 class="text-white font-weight-bolder text-center ">Kecamatan
                                            Mandastana</h5>
                            ...
                            <div class="card-body">
                                ...
                                <form action="db/cek_login.php" method="post">
                                    ...
                                    <p class="text-white mt-4 text-sm text-center">
                                        ...
                                        <a href="../e-arsip/public/signup-msy.php"
